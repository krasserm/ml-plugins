...
async def _op_recommend(args: dict[str, Any], limit: int) -> ToolResult:
    ...
    # NB: the S2 *recommendations* API rejects `tldr` (400 "Unrecognized or
    # unsupported fields: [tldr]"), unlike the /graph/v1/paper endpoints. Keep
    # this field list to what recommendations supports.
    fields = "title,externalIds,year,citationCount,venue"
